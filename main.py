...
# SibSp
SibSp = st.sidebar.selectbox("Siblings or Spouses Aboard", ("No", "Yes"))
SibSp_dict = {'No': 0, 'Yes': 1}

# Parch
Parch = st.sidebar.number_input("Parents or Children Aboard", min_value=0, max_value=10, value=0)
...
if predict_button:
    ...
    st.markdown(f"<h2 class='animated-text'>Titanic survival prediction</h2>", unsafe_allow_html=True)
